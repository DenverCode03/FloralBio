...
export default function Ferti() {
    ...
    return (
        <>
            ...
            <div className="w-full bg-red-50 grid md:grid-cols-2 gap-8 md:gap-20 px-4 py-8 md:py-20 md:px-20">
                <div className="flex flex-col justify-center text-center md:text-left md:px-8">
                    <h2 className="mb-6 text-xl font-bold text-red-500 sm:text-2xl">
                ...
                <div className="mx-auto max-w-6xl">
                    ...
                    <div className="grid gap-12 md:grid-cols-2 items-center mb-16">
                        ...
                        <div className="order-2 md:order-2">
                            <h4 className="text-2xl font-bold text-red-600 mb-6">
                            ...
                            <div className="space-y-4 text-gray-700 mb-8">
                                ...
                                <div className="bg-orange-50 p-4 rounded-lg">
                                    <h5 className="font-semibold text-red-800 mb-2">Bénéfices de notre tisane détox :</h5>
                                    <ul className="space-y-2 text-sm text-orredange-700">
